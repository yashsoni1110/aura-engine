...
import { BarChart3, LayoutGrid, LogOut, Package, Wifi, UserCircle, Menu, X } from 'lucide-react';
import { clearSession } from '@/hooks/useAuthGuard';
import { useState, useEffect } from 'react';

const navItems = [
  { href: '/analytics', label: 'Command Center', icon: BarChart3, desc: 'Overview & KPIs' },
  { href: '/inventory',  label: 'Inventory Grid',  icon: LayoutGrid, desc: '50,000 SKUs' },
];
          ...
          <div style={{ padding: '8px 0 0', borderTop: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 8 }}>
            <Link
              ...
              style={{
                ...
                transition: 'background 0.2s, border-color 0.2s', cursor: 'pointer', textDecoration: 'none',
              }}
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: isProfileActive ? 'var(--accent-light)' : 'var(--text-primary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', transition: 'color 0.2s' }}>
                  {adminName}
                </div>
